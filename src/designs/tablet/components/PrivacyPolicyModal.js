...
import { X, Shield, Eye, Database, UserCheck, Mail, Phone } from 'lucide-react';
...
const PrivacyPolicyModal = ({ isOpen, onClose }) => {
  ...
  return (
    <div className="modal-overlay" onClick={onClose}>
      <div className="modal-container privacy-modal dashboard-modal" onClick={e => e.stopPropagation()}>
        {/* Header */}
