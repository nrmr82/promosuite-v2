...
const Pricing = ({ user, onUpgrade, onClose }) => {
  ...
  const getPriceId = (planId, cycle) => {
    const priceMap = {
      starter: {
        ...
        annually: import.meta.env.VITE_STRIPE_STARTER_YEARLY_PRICE_ID
      },
      pro: {
  ...
  const getCreditPackagePriceId = (packageId) => {
    const priceMap = {
      'credits-500': import.meta.env.VITE_STRIPE_CREDITS_500_PRICE_ID,
      'credits-1500': import.meta.env.VITE_STRIPE_CREDITS_1500_PRICE_ID,
      'credits-5000': import.meta.env.VITE_STRIPE_CREDITS_5000_PRICE_ID
    };
