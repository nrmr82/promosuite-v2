...
variables (they're public price IDs, not secrets): `VITE_STRIPE_STARTER_MONTHLY_PRICE_ID`,
`VITE_STRIPE_STARTER_YEARLY_PRICE_ID`, `VITE_STRIPE_PRO_MONTHLY_PRICE_ID`,
`VITE_STRIPE_PRO_YEARLY_PRICE_ID`, `VITE_STRIPE_CREDITS_500_PRICE_ID`,
`VITE_STRIPE_CREDITS_1500_PRICE_ID`, `VITE_STRIPE_CREDITS_5000_PRICE_ID`.
